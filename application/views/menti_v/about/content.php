                        ...
                        <div class="col-md-12 col-sm-12">
                            <div class="user-card p-0">
                                <div class="media white">
                                    ...
                                    <div class="media-left">
                                        <div class="avatar avatar-lg avatar-circle" style="padding: 5px;">
                                            <a href="javascript:void(0)"><img src="<?= get_picture( "users_v", get_user_info($available->teacher_id)->img_url, '80x80'); ?>" alt=""></a>
                                            <i class="status status-online"></i>
                                        </div>
                                    </div>
                                    <div class="media-body">
                                        <h5 class="media-heading"><a href="javascript:void(0)" class="title-color"> <?= get_user_info($available->teacher_id)->full_name; ?> </a></h5>
