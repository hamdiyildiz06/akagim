...
class Settings extends HY_Controller
{
    ...
    public function save(){
        ...
        if($validate){
            ...
            $image_150x70 = upload_picture($_FILES["logo"]["tmp_name"], "uploads/$this->viewFolder",150,70, $file_name);
            ...
            if($image_150x70 && $image_300x70 && $image_32x32){
    ...
    public function update($id){
        ...
        if($validate){
            ...
            if($_FILES["logo"]["name"] !== "") {
                ...
                $image_150x35 = upload_picture($_FILES["logo"]["tmp_name"], "uploads/$this->viewFolder",150,70, $file_name);

                if($image_150x70){
                    delete_picture("settings_model", $id, "150x70");
                    $data["logo"] = $file_name;
